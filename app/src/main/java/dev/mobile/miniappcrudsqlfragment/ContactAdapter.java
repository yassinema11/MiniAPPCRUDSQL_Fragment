...
import dev.mobile.miniappcrudsqlfragment.databinding.RecycleviewitemBinding;
...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ContactViewHolder> {
            ...
            public boolean onLongClick(View v)
            {
                ...
                builder.setPositiveButton("Oui !", new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which)
                    {
                        ...
                        Toast.makeText(context, "Suppression du contact " + position + " " + listeContact.get(position).getNumber() + " avec succès", Toast.LENGTH_LONG).show();
                        dialog.dismiss();
    ...
    public static class ContactViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public void bind(Contact contact)
        {
            ...
            binding.txtvnom.setText("Nom: " + contact.getNom());
            binding.txtnumero.setText("Number: " + contact.getNumber());
        }
    }
}
